describe('Controller: MenuController', function () {
    ...
    //injection comes after the menucontroller being declared
    ...
    it('should create "dishes" with 2 dishes fetched from xhr', function(){
        ...
        expect(scope.dishes.length).toBe(2);    //dishes object should be 2 in length
    ...
    //Own test that tests whether description is the value of "A"
    it ('should have "description" as a', function() {
        expect(scope.dishes[0].description).toBe("A");
